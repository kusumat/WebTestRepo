...
// 	else
  ...
  j:0,
 refresh:function(seguiWidget)
{
	if (this.j == 24)
		this.j = 0;
	var data = { lblData : "Inserted contact"+this.j  }
	...
	kony.timer.schedule("newTimer", this.dismiLoadScrnRefresh,2,false);

		this.view.segStates.addDataAt(data, 0, this.j);
	
	this.j++;
},
   dismiLoadScrnRefresh:function()
{
