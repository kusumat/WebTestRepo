...
// 	else
   ...
   onEditingIconStyle:function(seguiWidget, editmode, sectionIndex, rowIndex)
{
	if (editmode == 2)	
...
// 	{
// 		i++;
// 		var data = { lblData : "Inserted contact"+i,metaInfo :{editMode:constants.SEGUI_EDIT_MODE_DELETE} }
